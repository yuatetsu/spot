...
//    NSMutableArray *all;
    NSMutableDictionary *lastFilesSynced;
   
}

@property (nonatomic, assign) BOOL isImageFinishSynced;
@property (nonatomic, assign) BOOL isVoiceFinishSynced;
@property (nonatomic, assign) BOOL isSpotFinishSynced;
@property (nonatomic, assign) BOOL isGuideBookFinishSynced;

@property (nonatomic, strong)NSMutableDictionary *remoteFiles;
@property (nonatomic, strong)NSMutableDictionary *localFiles;
@property (nonatomic, strong)dispatch_queue_t syncQueue;

@property (nonatomic, assign)BOOL fileExitOnLocal;
...
@property (nonatomic, assign) int numberFilesUpload;
@property (nonatomic, assign) int numberFilesDownload;
@property (nonatomic, strong) NSString *syncingPath;
...
- (void)uploadLocalDocumentToCloudWithName:(NSString *)documentName localPath:(NSString*)local_path completion:(void (^)(NSError *error))handler __attribute__((nonnull));
