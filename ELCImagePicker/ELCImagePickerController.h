...
typedef NS_ENUM(NSUInteger, TypeImageTablePicker) {
    
    TypeImagePickerPhoto,
    TypeImagePickerNameCard,
};

#define IMAGE_TYPE @"image_type"
#define IMAGE_PRESELECT_RETURNED @"image_select_returned"
#define TIME_LINE_KEY @"time_line"
...
//edit by nguyen hai dang for spot
