...
//            [imageView setContentMode:UIViewContentModeCenter];
        ...
        if (_scrollView.subviews.count == 0) {
            ...
            UIActivityIndicatorView *loadActivityIndicator = [UIActivityIndicatorView new];
            loadActivityIndicator.center = (CGPoint){_scrollView.frame.size.width/2, _scrollView.frame.size.height/2};
            loadActivityIndicator.activityIndicatorViewStyle = UIActivityIndicatorViewStyleGray;
            
            [blankImage addSubview:loadActivityIndicator];
