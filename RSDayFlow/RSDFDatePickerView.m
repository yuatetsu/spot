...
- (void)configureCalendar
{
    ...
    _fromDate = [self pickerDateFromDate:[_calendar dateByAddingComponents:((^{
        ...
        //components.month = -6;
        components.month = 1 -[[_calendar components:NSYearCalendarUnit|NSMonthCalendarUnit fromDate:[NSDate date]] month];
        return components;
    ...
    _toDate = [self pickerDateFromDate:[_calendar dateByAddingComponents:((^{
        NSDateComponents *components = [NSDateComponents new];
        //components.month = 6;
        components.month = 1 + 12 -[[_calendar components:NSYearCalendarUnit|NSMonthCalendarUnit fromDate:[NSDate date]] month];
        return components;
    })()) toDate:now options:0]];
...
{
    self = [self initWithFrame:frame forYear:year];
    NSDateComponents *dateComponents = [[NSDateComponents alloc] init];
    [dateComponents setDay:day];
    [dateComponents setMonth:month];
    [dateComponents setYear:year];
    NSCalendar *calendar = [[NSCalendar alloc] initWithCalendarIdentifier:NSGregorianCalendar];
    _today = [calendar dateFromComponents:dateComponents];
    return self;
}
...
- (void)layoutSubviews
{
	...
	if (!self.collectionView.superview) {
        if (self.collectionView.numberOfSections > 0) {
            ...
            NSInteger section = [[_calendar components:NSYearCalendarUnit|NSMonthCalendarUnit fromDate:[NSDate date]] month] - 1;
            ...
            if (_fromDate.year == [self pickerDateFromDate:_today].year)
            {
